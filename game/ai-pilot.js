// ==========================================
// AI PILOT ENGINE (Autonomous Auto-Pilot & Cyber Gaze)
// 三段式自主 AI 副駕駛、威脅度計算與眼球凝視系統
// ==========================================
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { AIPilot };
}
if (typeof window !== 'undefined') {
    window.TypingGamePilot = { AIPilot };
}
